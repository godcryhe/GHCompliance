<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/Users/yhe/Projects/GHComp/public/../application/home/view/customers/index.html";i:1538369545;s:66:"/Users/yhe/Projects/GHComp/application/home/view/public/index.html";i:1539065316;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Required meta tags -->
...
<span class="p"><a href="/customers/add">Add Customer</a></span>

<div style="margin-top:20px">
	<table class="table table-border table-bordered table-bg table-hover table-sort " text-align="center" id="idTblCust">
		...
		<tr class="text-c">
			...
			<td><?php echo $row['cust_type_str']; ?></td>
			<td><?php echo $row['formatted_cust_name']; ?></td>
			<td class='static'>-- todo --</td>
			<td><?php echo $row['address']; ?></td>
			<td><?php echo $row['city']; ?></td>
			<td><?php echo $row['province']; ?></td>
			<td>-- todo --</td>
			<td class="static2 <?php echo $row->status_class; ?>" ><?php echo $row->status; ?></td>
			<td class="h"><a href="/customers/view/id/<?php echo $row['cust_id']; ?>">View</a></td>
		</tr>
