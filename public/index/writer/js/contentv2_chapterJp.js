...
if(status){window.editor.insertContent('<p class="tinymce-insert-wrap"><img src="'+img_url+'"></p>');$('#imgUpload').val('');}else{var err_info=$(data).find('info').text();_dialog.alert(err_info||'上传失败，请稍候再试');}
